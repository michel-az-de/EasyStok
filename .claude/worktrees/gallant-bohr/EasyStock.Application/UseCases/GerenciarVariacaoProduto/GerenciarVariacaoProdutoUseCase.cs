    ...
    IUnitOfWork unitOfWork)
{
    ...
    {
        if (empresaId == Guid.Empty) throw new UseCaseValidationException("EmpresaId e obrigatorio.");
        if (produtoId == Guid.Empty) throw new UseCaseValidationException("ProdutoId e obrigatorio.");
