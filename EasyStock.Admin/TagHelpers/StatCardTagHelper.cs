...
/// <summary>
/// Stat card (KPI) com valor animado, delta vs período anterior e sparkline opcional.
/// Pode virar link clicável (drill-down) passando href.
///
/// Uso:
///   <es-stat-card label="Clientes ativos"
///                 value="1.247"
///                 delta="+12.5%"
///                 delta-trend="up"
///                 delta-meta="vs 30d"
///                 sparkline="120,135,128,145,162,158,180"
///                 href="/Tenants?status=Ativa" />
///
///   <es-stat-card label="Receita estimada"
///                 value="R$ 84.300"
///                 sub="MRR atual"
///                 animated="true" />
/// </summary>
...
public sealed class StatCardTagHelper : TagHelper
{
    ...
    /// <summary>Texto opcional secundário abaixo do valor (ex.: "MRR atual").</summary>
    ...
    /// <summary>Texto à direita do delta (ex.: "vs últimos 7d").</summary>
    [HtmlAttributeName("delta-meta")]
    public string? DeltaMeta { get; set; }

    /// <summary>CSV ou IEnumerable&lt;double&gt; — se preenchido renderiza sparkline atrás do valor.</summary>
    public object? Sparkline { get; set; }

    /// <summary>up | down | flat | auto. Auto compara primeiro vs último.</summary>
    [HtmlAttributeName("sparkline-trend")]
    public string SparklineTrend { get; set; } = "auto";

    /// <summary>Quando setado, o card vira <a href="..."> clicável (drill-down).</summary>
    public string? Href { get; set; }

    /// <summary>Animação do número via Alpine x-init (CountUp simples). Default false.</summary>
    public bool Animated { get; set; }

    /// <summary>Valor numérico para CountUp (default: parse do Value se animated=true).</summary>
    ...
    private static string ResolveDeltaTrendClass(string delta, string? explicitTrend)
    {
    ...
    private static string BuildSparklineSvg(object input, string trend)
    {
    ...
    private static List<double> SparklineNormalize(object input)
    {
