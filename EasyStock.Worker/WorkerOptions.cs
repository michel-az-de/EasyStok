...
public sealed class WorkerOptions
{
    ...
    /// <summary>Intervalo (em segundos) entre ticks do BannerNotificacaoService (#869). Mínimo 60. Padrão 120 (2 min).</summary>
    public int BannerNotificacaoIntervalSeconds { get; set; } = 120;
