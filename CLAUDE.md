...
## 4. ESTADO CONHECIDO DO REPO (snapshot 2026-05-28)

Master: sincronizado com origin (0/0 ahead/behind)
HEAD master: 21cd7d00 TASK-EZ-WEB-005: IJwtClaimsReader consolida ExtractClaim (#255)
Build: verde (0 erros, 8 warnings pre-existentes)
Working tree: limpo
...
- SQLite dev-fallback incompleto (AddEasyStockSqliteInfrastructure registra
  ~25 repos a menos que Postgres; app nao sobe em SQLite/Development).
