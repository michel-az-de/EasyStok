...
namespace EasyStock.Infra.Postgre.Migrations
{
    ...
    [Migration("20260809132157_AddClientePessoaJuridica")]
    partial class AddClientePessoaJuridica
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.AjusteInventario", b =>
                {
                    ...
                    b.HasIndex("ContagemId")
                        .HasDatabaseName("ix_ajustes_inventario_contagem");
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.AjusteInventarioLinha", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("CustoUnitarioSnapshot")
                    ...
                    b.Property<decimal>("QtdAntes")
                        .HasColumnType("numeric(18,3)");

                    b.Property<decimal>("QtdDepois")
                        .HasColumnType("numeric(18,3)");
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.Cliente", b =>
                {
                    ...
                    b.ToTable("clientes", null, t =>
                        {
                            t.HasCheckConstraint("ck_clientes_tipo_pessoa", "\"TipoPessoa\" IN ('fisica','juridica')");
                        });
                });
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.ConfiguracaoLoja", b =>
                {
                    ...
                    b.Property<int>("DiasCoberturaAlvo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(7);
                    ...
                    b.Property<bool>("KdsHabilitado")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);

                    b.Property<int>("LeadTimePadraoDias")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(7);
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.Contagem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("AplicadoPorUsuarioId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("EscopoRefId")
                        .HasColumnType("uuid");

                    b.Property<string>("EstrategiaLote")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.ToTable("contagens", (string)null);
                });
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.ItemContagem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ContadoPorUsuarioId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal?>("QtdContada")
                        .HasColumnType("numeric(18,3)");

                    b.Property<decimal?>("QtdSistemaNoMomento")
                        .HasColumnType("numeric(18,3)");
                    ...
                    b.HasIndex("ContagemId")
                        .HasDatabaseName("ix_itens_contagem_contagem");
                    ...
                    b.ToTable("itens_contagem", (string)null);
                });
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.ItemEstoque", b =>
                {
                    ...
                    b.Property<decimal>("QuantidadeDescoberta")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(18,3)")
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.MovimentacaoEstoque", b =>
                {
                    ...
                    b.HasIndex("EmpresaId", "ProdutoId", "Natureza", "DocumentoReferencia")
                        .IsUnique()
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.MovimentoCaixa", b =>
                {
                    ...
                    b.Property<DateTime?>("NotificadoEsquecidoEm")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.PedidoItem", b =>
                {
                    ...
                    b.Property<Guid?>("CardapioItemVariacaoId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("VariacaoRotuloSnapshot")
                        .HasMaxLength(60)
                        .HasColumnType("character varying(60)");
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.PreferenciaMenuUsuario", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("FavoritosMenu")
                        .IsRequired()
                        .HasColumnType("jsonb")
                    ...
                    b.ToTable("preferencias_menu_usuario", (string)null);
                });
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.Storefront.CardapioItemVariacao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CardapioItemId", "OrdemExibicao")
                        .HasDatabaseName("ix_cardapio_item_variacao_item_ordem");

                    b.ToTable("cardapio_item_variacao", (string)null);
                });

            modelBuilder.Entity("EasyStock.Domain.Entities.Storefront.CardapioSecao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SecaoPaiId");

                    b.HasIndex("StorefrontId", "SecaoPaiId", "OrdemExibicao")
                        .HasDatabaseName("ix_cardapio_secao_storefront_pai_ordem");

                    b.ToTable("cardapio_secao", null, t =>
                        {
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.Storefront.Storefront", b =>
                {
                    ...
                    b.Property<double?>("CozinhaLat")
                        .HasColumnType("double precision");

                    b.Property<double?>("CozinhaLng")
                        .HasColumnType("double precision");
                    ...
                    b.Property<int?>("FreteFaixaGratisMetros")
                        .HasColumnType("integer");

                    b.Property<string>("FreteFaixasJson")
                        .HasColumnType("text");

                    b.Property<double?>("FreteFatorRota")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.AjusteInventarioLinha", b =>
                {
                    b.HasOne("EasyStock.Domain.Entities.AjusteInventario", "AjusteInventario")
                        .WithMany("Linhas")
                    ...
                    b.HasOne("EasyStock.Domain.Entities.ItemEstoque", null)
                        .WithMany()
                        .HasForeignKey("ItemEstoqueId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EasyStock.Domain.Entities.Produto", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.Storefront.CardapioItem", b =>
                {
                    ...
                    b.HasOne("EasyStock.Domain.Entities.Storefront.CardapioSecao", "Secao")
                        .WithMany()
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.Storefront.CardapioItemVariacao", b =>
                {
                    b.HasOne("EasyStock.Domain.Entities.Storefront.CardapioItem", "CardapioItem")
                        .WithMany("Variacoes")
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.Storefront.CardapioSecao", b =>
                {
                    b.HasOne("EasyStock.Domain.Entities.Storefront.CardapioSecao", "SecaoPai")
                        .WithMany("SubSecoes")
                        .HasForeignKey("SecaoPaiId")
                        .OnDelete(DeleteBehavior.Restrict);
