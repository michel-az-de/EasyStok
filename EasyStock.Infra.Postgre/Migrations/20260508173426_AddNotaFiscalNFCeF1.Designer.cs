...
namespace EasyStock.Infra.Postgre.Migrations
{
    ...
    [Migration("20260508173426_AddNotaFiscalNFCeF1")]
    partial class AddNotaFiscalNFCeF1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.Fiscal.NotaFiscal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ProtocoloAutorizacao")
                        ...
                        .HasColumnName("protocolo_autorizacao");
                    ...
                    b.Property<string>("XmlAssinadoLocal")
                        .HasColumnType("text")
                        .HasColumnName("xml_assinado_local");
                    ...
                    b.HasIndex("EmpresaId", "LojaId", "IdempotencyKey")
                        .IsUnique()
                    ...
                    b.HasIndex("EmpresaId", "LojaId", "Modelo", "Serie", "Numero")
                        .IsUnique()
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.Fiscal.NotaFiscalCertificadoA1", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<byte[]>("PfxCifrado")
                        .IsRequired()
                        .HasColumnType("bytea")
                        .HasColumnName("pfx_cifrado");
                    ...
                    b.ToTable("nota_fiscal_certificado_a1", (string)null);
                });

            modelBuilder.Entity("EasyStock.Domain.Entities.Fiscal.NotaFiscalContador", b =>
                {
                    b.Property<Guid>("EmpresaId")
                        .HasColumnType("uuid")
                        .HasColumnName("empresa_id");
                    ...
                    b.HasKey("EmpresaId", "LojaId", "Modelo", "Serie");

                    b.ToTable("nota_fiscal_contador", (string)null);
                });

            modelBuilder.Entity("EasyStock.Domain.Entities.Fiscal.NotaFiscalEvento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("NotaFiscalId", "OcorridoEm")
                        .HasDatabaseName("ix_nota_fiscal_evento_nf");

                    b.ToTable("nota_fiscal_evento", (string)null);
                });

            modelBuilder.Entity("EasyStock.Domain.Entities.Fiscal.NotaFiscalInutilizacao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("XmlInutilizacao")
                        .HasColumnType("text")
                        .HasColumnName("xml_inutilizacao");

                    b.HasKey("Id");

                    b.HasIndex("EmpresaId", "LojaId", "Modelo", "Serie", "Ano")
                        .HasDatabaseName("ix_nota_fiscal_inut_loja_serie_ano");

                    b.ToTable("nota_fiscal_inutilizacao", (string)null);
                });

            modelBuilder.Entity("EasyStock.Domain.Entities.Fiscal.NotaFiscalItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal?>("CbsAliquota")
                        .HasColumnType("numeric(5,4)")
                        .HasColumnName("cbs_aliquota");

                    b.Property<string>("CbsCst")
                        .HasMaxLength(3)
                        .HasColumnType("character varying(3)")
                        .HasColumnName("cbs_cst");

                    b.Property<decimal?>("CbsValor")
                        .HasColumnType("numeric(14,2)")
                    ...
                    b.Property<decimal?>("CofinsAliquota")
                        .HasColumnType("numeric(5,4)")
                        .HasColumnName("cofins_aliquota");

                    b.Property<decimal?>("CofinsValor")
                        .HasColumnType("numeric(14,2)")
                    ...
                    b.Property<decimal?>("IbsAliquota")
                        .HasColumnType("numeric(5,4)")
                        .HasColumnName("ibs_aliquota");

                    b.Property<string>("IbsCst")
                        .HasMaxLength(3)
                        .HasColumnType("character varying(3)")
                        .HasColumnName("ibs_cst");

                    b.Property<decimal?>("IbsValor")
                        .HasColumnType("numeric(14,2)")
                        .HasColumnName("ibs_valor");

                    b.Property<decimal?>("IcmsAliquota")
                        .HasColumnType("numeric(5,4)")
                        .HasColumnName("icms_aliquota");

                    b.Property<int?>("IcmsModalidadeBC")
                        .HasColumnType("integer")
                        .HasColumnName("icms_modalidade_bc");

                    b.Property<decimal?>("IcmsValor")
                        .HasColumnType("numeric(14,2)")
                        .HasColumnName("icms_valor");

                    b.Property<decimal?>("IsAliquota")
                        .HasColumnType("numeric(5,4)")
                        .HasColumnName("is_aliquota");

                    b.Property<string>("IsCst")
                        .HasMaxLength(3)
                        .HasColumnType("character varying(3)")
                        .HasColumnName("is_cst");

                    b.Property<decimal?>("IsValor")
                        .HasColumnType("numeric(14,2)")
                    ...
                    b.Property<short>("OrigemMercadoria")
                        .HasColumnType("smallint")
                        .HasColumnName("origem_mercadoria");

                    b.Property<decimal?>("PisAliquota")
                        .HasColumnType("numeric(5,4)")
                        .HasColumnName("pis_aliquota");

                    b.Property<decimal?>("PisValor")
                        .HasColumnType("numeric(14,2)")
                    ...
                    b.HasIndex("NotaFiscalId")
                        .HasDatabaseName("ix_nota_fiscal_item_nf");

                    b.ToTable("nota_fiscal_item", (string)null);
                });

            modelBuilder.Entity("EasyStock.Domain.Entities.Fiscal.NotaFiscalPagamento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("CnpjCredenciadora")
                        .HasMaxLength(14)
                        .HasColumnType("character varying(14)")
                        .HasColumnName("cnpj_credenciadora");
                    ...
                    b.HasIndex("NotaFiscalId")
                        .HasDatabaseName("ix_nota_fiscal_pagamento_nf");

                    b.ToTable("nota_fiscal_pagamento", (string)null);
                });
            ...
            modelBuilder.Entity("EasyStock.Domain.Entities.Fiscal.NotaFiscalEvento", b =>
                {
                    b.HasOne("EasyStock.Domain.Entities.Fiscal.NotaFiscal", null)
                        .WithMany("Eventos")
