...
#   CDB_API_BASE_URL  URL da API EasyStok (default: https://api.20.98.234.200.sslip.io = VM Azure canonica, host consolidado #997)
...
CDB_API_BASE_URL="${CDB_API_BASE_URL:-https://api.20.98.234.200.sslip.io}"
